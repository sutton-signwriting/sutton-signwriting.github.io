...
const {pages, backPages, doc} = createPages({status, packages, publications, release});
...
console.log(`Built ${pages.size} technology pages and ${backPages.size} Back Office pages; version ${release.version}.`);
